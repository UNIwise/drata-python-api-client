...
) -> Optional[Union[ExceptionResponseDto, ExceptionResponsePublicDto, UserResponsePublicDto]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ExceptionResponseDto, ExceptionResponsePublicDto, UserResponsePublicDto]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ExceptionResponseDto, ExceptionResponsePublicDto, UserResponsePublicDto]
    """
