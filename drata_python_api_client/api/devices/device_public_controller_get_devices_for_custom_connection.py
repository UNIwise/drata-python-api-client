...
from ...models.device_public_controller_get_devices_for_custom_connection_expand_item import (
...
def _get_kwargs(
    ...
    *,
    ...
    expand: Union[Unset, list[DevicePublicControllerGetDevicesForCustomConnectionExpandItem]] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        expand (Union[Unset,
            list[DevicePublicControllerGetDevicesForCustomConnectionExpandItem]]):  Example:
            COMPLIANCE_CHECKS.
