...
from ...models.note_request_public_dto import NoteRequestPublicDto
...
def _get_kwargs(
    ...
    note_id: str,
    *,
    body: NoteRequestPublicDto,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/workspaces/{workspace_id}/controls/{control_id}/notes/{note_id}",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = NoteResponsePublicDto.from_dict(response.json())
