...
from ...models.vendor_request_public_dto import VendorRequestPublicDto
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = VendorResponsePublicDto.from_dict(response.json())
