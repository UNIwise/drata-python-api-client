...
from ...models.vendor_document_request_public_dto import VendorDocumentRequestPublicDto
...
def _get_kwargs(
    id: float,
    *,
    body: VendorDocumentRequestPublicDto,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/vendors/{id}/documents",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = VendorsResponsePublicDto.from_dict(response.json())
