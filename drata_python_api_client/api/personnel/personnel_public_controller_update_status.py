...
from ...models.personnel_status_request_public_dto import PersonnelStatusRequestPublicDto
...
def _get_kwargs(
    id: float,
    *,
    body: PersonnelStatusRequestPublicDto,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/personnel/{id}/status",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Update personnel employment status

     Update the employment status of a personnel record
