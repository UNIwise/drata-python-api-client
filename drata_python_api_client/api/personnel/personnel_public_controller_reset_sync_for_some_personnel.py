...
from ...models.personnel_reset_status_request_public_dto import PersonnelResetStatusRequestPublicDto
from ...types import Response


def _get_kwargs(
    *,
    body: PersonnelResetStatusRequestPublicDto,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/personnel/some/reset-sync",
    }
...
def sync_detailed(
    *,
    ...
    """Reset sync status for some personnel

     Re-enable IdP/HRIS sync for some personnel records
