...
from ...models.user_identity_version_control_toggle_request_public_dto import (
...
def _get_kwargs(
    id: float,
    *,
    body: UserIdentityVersionControlToggleRequestPublicDto,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/user-identities/version-control/{id}/toggle",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Update target version control user identity toggle settings

     Update the toggle setting for the target version control user identity
