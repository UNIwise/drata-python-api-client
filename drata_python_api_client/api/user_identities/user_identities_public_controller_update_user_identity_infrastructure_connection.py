...
from ...models.user_identity_infrastructure_connect_request_public_dto import (
...
def _get_kwargs(
    id: float,
    *,
    body: UserIdentityInfrastructureConnectRequestPublicDto,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/user-identities/infrastructure/{id}/connect",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Update infrastructure user identity connection status

     Update the connection status for the target infrastructure user identity
