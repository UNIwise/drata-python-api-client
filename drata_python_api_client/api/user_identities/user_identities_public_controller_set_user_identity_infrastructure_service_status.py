...
from ...models.user_identity_infrastructure_service_status_request_public_dto import (
...
def _get_kwargs(
    id: float,
    *,
    body: UserIdentityInfrastructureServiceStatusRequestPublicDto,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/user-identities/infrastructure/{id}/service-account",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Update infrastructure user identity to a service account

     Update the target infrastructure user identity to a service account
