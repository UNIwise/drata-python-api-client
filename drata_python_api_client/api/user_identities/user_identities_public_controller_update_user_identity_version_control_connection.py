...
from ...models.user_identity_version_control_connect_request_public_dto import (
...
def _get_kwargs(
    id: float,
    *,
    body: UserIdentityVersionControlConnectRequestPublicDto,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/user-identities/version-control/{id}/connect",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Update version control user identity connection status

     Update the connection status for the target version control user identity
