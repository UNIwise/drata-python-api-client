...
T = TypeVar("T", bound="ExceptionResponsePublicDto")


@_attrs_define
class ExceptionResponsePublicDto:
    """
    Attributes:
        name (str):
        status_code (float):
    ...
    message: str
    code: float
    debug_info: Union[Unset, "ExceptionResponsePublicDtoDebugInfo"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        exception_response_public_dto = cls(
            name=name,
        ...
        exception_response_public_dto.additional_properties = d
        return exception_response_public_dto
